...
export const messages = {
  en: {
    ...
    'quiz.groupth.prompt': 'The formula "(A AND B) OR (B AND C) OR (A AND C)" is fully symmetric under all 3! permutations of A, B, C. The truth table has 2³ = 8 rows. How many orbit representatives (distinct test inputs) are needed?',
    'quiz.groupth.label': 'Number of orbit representatives',
    'quiz.groupth.answer': 'Answer: {count} orbits — {000}, {one true}, {two true}, {111}.',
  ...
  zh: {
    ...
    'quiz.groupth.prompt': '公式「(A AND B) OR (B AND C) OR (A AND C)」在 A、B、C 的所有 3! 置換下完全對稱。真值表有 2³=8 列。需要幾個軌道代表元（不同測試輸入）？',
    'quiz.groupth.label': '軌道代表元數量',
    'quiz.groupth.answer': '答案：{count} 個軌道——{000}、{一個為真}、{兩個為真}、{111}。',
