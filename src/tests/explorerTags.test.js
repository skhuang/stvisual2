...
describe('Explorer tag metadata (K1)', () => {
  ...
  it('matches the component files actually shipped under src/components/', async () => {
    ...
    const componentNames = Object.keys(componentFiles)
      ...
      .filter((n) => !['CloudStoragePanel', 'TeacherDashboard', 'ResultViewer', 'TagFilterBar', 'CoursePackBar', 'SlideViewer', 'SlicePdgView', 'QuizViewer', 'LabViewer', 'ExampleControls'].includes(n));
